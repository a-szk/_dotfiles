...
sudo apt update
sudo apt -y install git vim neovim xsel rename tree colordiff vlc ffmpeg byobu x11vnc pm-utils net-tools indicator-cpufreq python-gi python-gi-cairo python3-gi python3-gi-cairo gir1.2-gtk-3.0 exfat-fuse exfat-utils openssh-server fcitx-mozc nload htop sysstat python-autopep8
